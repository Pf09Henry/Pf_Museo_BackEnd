...
const { User, Ticket, Review, Guide, Event, Donation, Category, Subscription, Role, Comprobante } = sequelize.models;
...
Comprobante.belongsTo(Subscription)
Comprobante.belongsTo(User)
